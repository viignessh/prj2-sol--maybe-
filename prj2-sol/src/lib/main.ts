...
// Define the CheckoutRequest type based on your definition
...
async function load(library: LendingLibrary, req: Record<string, string>): Promise<Errors.Result<void>> {
